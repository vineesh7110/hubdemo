...
<div className='fixed z-10 top-0 w-full'>
                <div className="bg-amber-300 text-center p-1 items-center justify-center flex text-amber-950 font-bold ">FREE SHIPPINGOn all orders over Rs. 750/- </div>
                <header className='flex flex-row justify-between border-b h-28 items-center justify-center p-4 bg-white '>
                    <Link to={'/'} className="font-sans text-4xl ">HUB<span className='text-amber-500'>ORG</span></Link>
                ...
                <footer className="bg-amber-300 text-amber-950">
